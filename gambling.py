...
type_if_fig = ('candle1', 'candle2', 'Линия')
selected_type_stock =st.selectbox("Выбери тип графика", type_if_fig)

color1 = st.color_picker("Первый цвет", label_visibility="visible")
color2 = st.color_picker("Второй цвет", label_visibility="visible")

if selected_type_stock == "candle1":
    plot_raw_data_candle(color1 = color1, color2 = color2)
elif selected_type_stock == "candle2":
    plot_raw_data_candle(color1 = color1, color2 = color2)
else:
     plot_raw_data()
